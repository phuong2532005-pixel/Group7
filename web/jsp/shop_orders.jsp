...
<div class="container mt-4 shop-orders-page">
    ...
    <form class="row g-2 mb-3" method="get" action="${pageContext.request.contextPath}/shop/orders">
        <div class="col-auto">
    ...
    <div class="paging-container">
        ...
        <div class="paging">
            <%-- Previous --%>
            <c:if test="${page > 1}">
                <c:url var="prevUrl" value="/shop/orders">
            ...
            <c:forEach begin="1" end="${totalPages}" var="p">
                <c:url var="pageUrl" value="/shop/orders">
            ...
            <c:if test="${page < totalPages}">
                <c:url var="nextUrl" value="/shop/orders">
                    <c:param name="page" value="${page + 1}"/>
                    <c:if test="${not empty statusFilter}"><c:param name="status" value="${statusFilter}"/></c:if>
                    <c:if test="${not empty sort}"><c:param name="sort" value="${sort}"/></c:if>
                </c:url>
